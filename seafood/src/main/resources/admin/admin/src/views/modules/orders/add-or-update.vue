	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template v-show="logistics">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="upload" v-if="type!='info' && !ro.picture" label="海鲜图片" prop="picture">
					<file-upload
						tip="点击上传海鲜图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="upload" v-else-if="ruleForm.picture" label="海鲜图片" prop="picture">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../seafood/upload');
        } else {
