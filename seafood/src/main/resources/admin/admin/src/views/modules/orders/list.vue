		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"margin":"0 0 20px 0","position":"relative"}' :inline="true" :model="searchForm">
				<el-row :style='{"width":"150px","position":"absolute","top":"0","left":"0","display":"block","zIndex":"1003"}' >
					...
					<div :style='{"margin":"0 0 5px","display":"inline-block"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#666","textAlign":"left","display":"inline-block","width":"100px","lineHeight":"40px","fontSize":"14px","fontWeight":"600","height":"40px"}' class="item-label">海鲜名称</label>
						<el-input v-model="searchForm.goodname" placeholder="海鲜名称" clearable></el-input>
					</div>
				...
				<el-row :style='{"margin":"0","justifyContent":"flex-end","display":"flex"}'>
					...
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#333","borderRadius":"40px","background":"rgba(184, 222, 74, 1)","width":"auto","fontSize":"14px","height":"40px"}'	v-if="isAuth('orders'+'/'+orderStatus,'品销量')"	type="warning"	@click="goodnameNumberChartDialog()">海鲜销量</el-button>
					...
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#333","borderRadius":"40px","background":"rgba(184, 222, 74, 1)","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'品销额')" type="warning" @click="goodnameAmountChartDialog()">海鲜销额</el-button>
			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='false' prop="picture" width="200" label="海鲜图片">
						<template slot-scope="scope">
